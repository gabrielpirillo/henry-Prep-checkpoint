...
function pluck(array, propiedad) { 
  ...
  let nuevoCoso = array.map(function(elemento){
...
function crearClasePersona() {
  ...
  class Persona {
    ...
    getFriends() {
      ...
      let genT = this.amigos.map(function(amigo){
        return amigo.nombre
      })
      return genT;
    }
    ...
    getPromedioEdad() {
      ...
      let sum = this.amigos.reduce(function (acc, amigos){
        return acc + amigos.edad;
      },0)
      let promedio = sum / this.amigos.length;
      return promedio;
    }
  };
